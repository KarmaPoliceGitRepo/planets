...
**Discussed in:**
- [Elastic Wave Anisotropic Cylindrical Plates](../notes/signal-processing/elastic-wave-anisotropic-cylindrical-plates.md) — dispersion curves for guided waves in anisotropic cylindrical shells; angular wavenumber treatment
- [Fundamentals of Signal Processing (Sound & Vibration)](../notes/signal-processing/fundamentals-signal-processing-sound-vibration.md) — phase vs. group velocity; dispersive propagation effects on pulse shape
- [CW Ultrasonic Phase Velocity Formula](../notes/signal-processing/cw-ultrasonic-phase-velocity-formula.md) — formula relating measured phase to phase velocity; phase unwrapping step
