...
| Link | Type | From | To |
|------|------|------|----|
| SoI ⇒ V3 ▽ {C0 … C10} | ⇒ realize / ▽ composition | System-of-Interest | selected variant + components |
| C10 ▽ {C4b, C5b} ⇒ reelcut/ | ▽ composition / ⇒ realize | Studio UI subsystem | ReelCut sub-model |
