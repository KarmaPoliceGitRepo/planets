...
| I-7 | Open | **Quality/debt:** fixed CR-M7/M8/M10/M11 + CR-L1/L3/L8. Deferred lower-risk MED/LOW: return-code checks (CR-M2), master measurement (CR-M3/M4), caption/chapter timing (CR-M5/M6), seek accuracy (CR-M1), adjacency heuristic (CR-M9), fps rounding (CR-L2), CR-L4–L7, L9–L11. | Batch-fix; fold structural items into TD register. |
